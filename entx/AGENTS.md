...
- Commit or push only with explicit user approval. Keep commits limited to verified, cohesive
  slices, and keep private license/configuration files out of commits.
