...
`,Vd=d(({defaultChecked:e=!1},[],t)=>{let n=K(!!e,t),o={local:n,defaultChecked:!!e,bind:void 0,controlled:void 0};return({checked:r,defaultChecked:i,bind:a,oncheckedchange:c,onchange:s,dom:l,disabled:p=!1,size:h,color:u,highContrast:f,type:m,role:g,value:y="on",data:w,style:k,...v},[],x)=>{let b=x[Gd],A=h??b?.size??"2",$=u??b?.color??"accent",_=f??b?.highContrast??!1,U=String(y);o.bind=a,o.controlled=b?void 0:r,!b&&W(n,a,x);let Me=b?b.renderValue===U:!!j(n,a,r);return Hc({...v,type:"radio",name:b?.name??v.name,value:U,checked:Me,required:b&&b.required||v.required,disabled:p,style:R($,k),data:P(w,{size:A,color:$,highContrast:_,state:Me?"checked":"unchecked"}),dom:[oe=>Kc(o,b,oe,x),...Hd(l)],onchange:(oe,te,pt,zn)=>{z(s,oe,te,pt,zn);let ut=te.checked;b&&ut?(V(b.local,b.bind,b.controlled,U,b.context),c&&c(!0,oe),b.onvaluechange&&b.onvaluechange(U,oe),b.controlled!==void 0&&Yc(b)):b||(V(n,a,r,ut,x),c&&c(ut,oe),r!==void 0&&(te.checked=Me))}})}}),Uc=d(({name:e,defaultValue:t},[],n)=>{let o=e||_c(n),r=Bo(t),i=K(r,n),a={local:i,defaultValue:r,bind:void 0,controlled:void 0,renderValue:r,context:n,element:void 0,onvaluechange:void 0,name:o,required:!1,size:"2",color:"accent",highContrast:!1},c=Object.create(n);return c[Gd]=a,({value:s,defaultValue:l,bind:p,onvaluechange:h,name:u=o,required:f=!1,disabled:m=!1,size:g="2",color:y="accent",highContrast:w=!1,dom:k,data:v,style:x,...b},A,$)=>(a.bind=p,a.controlled=Bo(s),a.context=$,a.onvaluechange=h,a.name=u,a.required=f,a.size=g,a.color=y,a.highContrast=w,W(i,p,$),a.renderValue=Bo(j(i,p,a.controlled)),d({context:c},()=>kn({...b,disabled:m,style:R(y,x),data:P(v,{size:g,color:y,highContrast:w}),dom:[_=>Wc(a,_),...Hd(k)]},A)))});Vd.Group=Uc;function Kc(e,t,n,o){if(n.defaultChecked=t?t.defaultValue===n.value:e.defaultChecked,t)return;let r=n.form;if(!r)return;let i=()=>queueMicrotask(()=>{let a=n.checked;V(e.local,e.bind,e.controlled,a,o),n.checked=!!j(e.local,e.bind,e.controlled),o.redraw()});return r.addEventListener("reset",i),()=>r.removeEventListener("reset",i)}function Wc(e,t){e.element=t;let n=t.form;if(!n)return;let o=()=>queueMicrotask(()=>{V(e.local,e.bind,e.controlled,e.defaultValue,e.context),e.context.redraw()});return n.addEventListener("reset",o),()=>n.removeEventListener("reset",o)}function Yc(e){e.element?.querySelectorAll('input[type="radio"]').forEach(t=>{t.checked=t.value===e.renderValue}),e.context.redraw()}function _c(e){let t=e;for(;t&&!Object.prototype.hasOwnProperty.call(t,Cn);)t=Object.getPrototypeOf(t);return t||=e,t[Cn]=(t[Cn]||0)+1,"sinewy-radio-"+t[Cn]}function Bo(e){return e==null?void 0:String(e)}function Hd(e){return e==null?[]:Array.isArray(e)?e:[e]}var lt=Vd;var Ud=Symbol("sinewy-theme"),Jc=q.Content`
...
CustomSelect({ bind: produce, name: 'produce', 'aria-label': 'Produce' },
  ...
  CustomSelect.Option({ value: 'carrot' }, 'Carrot')
)`))}var Fs=d(()=>{let e=d.live("pear"),t="Choose a value, then submit or reset.";return()=>d`div display grid; gap 24`(si($n(d`label`({for:"custom-produce"},"Custom picker"),me({id:"custom-produce",bind:e,defaultValue:"pear",color:"cyan"},Vo(me)),d`p`("No search input. Type a letter to jump to an option.")),$n(d`label`({for:"native-produce"},"Native picker"),ee({id:"native-produce",bind:e,color:"cyan"},Vo(ee)),d`p`("The same selection, using the platform picker."))),d`div display flex; gap 12; flex-wrap wrap`(["1","2","3"].map(n=>me({size:n,defaultValue:"pear","aria-label":"Size "+n,style:{width:"140px"}},Vo(me)))),d`form display grid; gap 12`({onsubmit:n=>{n.preventDefault(),t="Submitted: "+new FormData(n.currentTarget).get("delivery")},onreset:()=>t="Reset: choose a delivery method."},d`label`({for:"delivery-method"},"Delivery method (required)"),me({id:"delivery-method",name:"delivery",required:!0,placeholder:"Choose delivery",color:"indigo"},me.Option({value:"standard"},"Standard delivery"),me.Option({value:"express"},"Express delivery"),me.Option({value:"collection",disabled:!0},"Collection \u2014 unavailable")),d`div display flex; gap 8`(Le({type:"submit"},"Submit"),Le({type:"reset",variant:"outline"},"Reset")),d`p`({role:"status"},t)))});function Vo(e){return[e.Group({label:"Fruit"},e.Option({value:"apple"},"Apple"),e.Option({value:"pear"},"Pear"),e.Option({value:"orange",disabled:!0},"Orange \u2014 unavailable")),e.Group({label:"Vegetables"},e.Option({value:"carrot"},"Carrot"),e.Option({value:"broccoli"},"Broccoli"))]}var Gs=d(()=>{let e=d.live(["email"]);return()=>st.Group({bind:e,name:"channels",color:"green"},d`legend`("Notifications"),Ie(st({value:"email"}),"Email"),Ie(st({value:"sms"}),"SMS"),Ie(st({value:"push"}),"Push"))});function Vs(){return d`section#live-example`(d`h2`("Live example"),d`p`("The fieldset binds its checked native values to one array while labels, form data, focus, and toggling remain HTML behavior."),d`div`(ce(Gs()),se(`import s from 'sin'
