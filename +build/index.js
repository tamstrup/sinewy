...
`,Lc=i`p
  ...
  font-size 14
  line-height 1.55
`,it=i(({id:e,defaultOpen:t=!1},[],n)=>{let o=e||Mc(n),r=W(!!t,n),d={id:o,contentId:o+"-content",titleId:o+"-title",descriptionId:o+"-description",content:void 0,trigger:void 0,local:r,bind:void 0,controlled:void 0,renderOpen:!!t,onopenchange:void 0,closing:!1},a=Object.create(n);return a[jo]=d,({open:c,defaultOpen:s,bind:l,onopenchange:p},h,u)=>(d.bind=l,d.controlled=c,d.onopenchange=p,Y(r,l,u),d.renderOpen=!!j(r,l,c),No(d),i({context:a},()=>h))});it.Trigger=i(({disabled:e=!1,dom:t,onclick:n,size:o="2",variant:r="solid",color:d="accent",highContrast:a=!1,type:c="button",data:s,style:l,...p},h,u)=>{let g=$t(u,"Trigger");return Oc({...p,type:c,disabled:e,"aria-haspopup":"dialog","aria-controls":g.contentId,"aria-expanded":String(g.renderOpen),style:q(d,l),data:$(s,{size:o,variant:r,color:d,highContrast:a,state:g.renderOpen?"open":"closed"}),dom:[m=>g.trigger=m,...Fi(t)],onclick:(m,f,y,v)=>{z(n,m,f,y,v),!(m.defaultPrevented||e)&&kn(g,!0,m,u)}},h)});it.Content=i(({dom:e,oncancel:t,onclose:n,"aria-label":o,"aria-labelledby":r,"aria-describedby":d,size:a="2",color:c="accent",highContrast:s=!1,data:l,style:p,...h},u,g)=>{let m=$t(g,"Content");return qc({...h,id:m.contentId,"aria-label":o,"aria-labelledby":o?r:r||m.titleId,"aria-describedby":d===null?void 0:d||m.descriptionId,style:q(c,p),data:$(l,{size:a,color:c,highContrast:s,state:m.renderOpen?"open":"closed"}),dom:[f=>{m.content=f,queueMicrotask(()=>No(m))},...Fi(e)],oncancel:(f,y,v,x)=>{z(t,f,y,v,x),!f.defaultPrevented&&(f.preventDefault(),kn(m,!1,f,g))},onclose:(f,y,v,x)=>{if(z(n,f,y,v,x),m.closing){m.closing=!1;return}m.renderOpen&&kn(m,!1,f,g)}},u)});it.Title=i((e,t,n)=>{let o=$t(n,"Title");return Rc({...e,id:e.id||o.titleId},t)});it.Description=i((e,t,n)=>{let o=$t(n,"Description");return Lc({...e,id:e.id||o.descriptionId},t)});it.Close=i(({disabled:e=!1,onclick:t,size:n="2",variant:o="soft",color:r="gray",highContrast:d=!1,type:a="button",data:c,style:s,...l},p,h)=>{let u=$t(h,"Close");return Ec({...l,type:a,disabled:e,style:q(r,s),data:$(c,{size:n,variant:o,color:r,highContrast:d}),onclick:(g,m,f,y)=>{z(t,g,m,f,y),!(g.defaultPrevented||e)&&kn(u,!1,g,h)}},p)});function kn(e,t,n,o){t!==e.renderOpen&&(G(e.local,e.bind,e.controlled,t,o),e.renderOpen=!!j(e.local,e.bind,e.controlled),e.onopenchange&&e.onopenchange(t,n),queueMicrotask(()=>No(e)))}function No(e){let t=e.content;!t||!t.isConnected||(e.renderOpen&&!t.open?t.showModal():!e.renderOpen&&t.open&&(e.closing=!0,t.close()))}function $t(e,t){let n=e[jo];if(!n)throw new Error("Dialog."+t+" must be used inside Dialog");return n}function Mc(e){let t=e,n;for(;(n=Object.getPrototypeOf(t))&&n!==Object.prototype;)t=n;let o=t[Ni]||(t[Ni]={value:0});return"sinewy-dialog-"+ ++o.value}function Fi(e){return e==null?[]:Array.isArray(e)?e:[e]}var _=it;var dt=i((e,t)=>_(e,...t));dt.Trigger=_.Trigger;dt.Content=i((e,t)=>_.Content({...e,role:"alertdialog"},t));dt.Title=_.Title;dt.Description=_.Description;dt.Close=_.Close;var De=dt;var Bc=i`input
...
`,jc=i(({defaultChecked:e=!1},[],t)=>{let n=W(!!e,t),o={local:n,defaultChecked:!!e,bind:void 0,controlled:void 0};return({checked:r,defaultChecked:d,bind:a,oncheckedchange:c,onchange:s,dom:l,disabled:p=!1,size:h="2",color:u="accent",highContrast:g=!1,type:m,role:f,data:y,style:v,...x},[],w)=>{o.bind=a,o.controlled=r,Y(n,a,w);let k=!!j(n,a,r);return Bc({...x,type:"checkbox",role:"switch",checked:k,disabled:p,style:q(u,v),data:$(y,{size:h,color:u,highContrast:g,state:k?"checked":"unchecked"}),dom:[b=>Nc(o,b,w),...Fc(l)],onchange:(b,S,I,H)=>{z(s,b,S,I,H);let K=S.checked;G(n,a,r,K,w),c&&c(K,b),r!==void 0&&(S.checked=k)}})}});function Nc(e,t,n){t.defaultChecked=e.defaultChecked;let o=t.form;if(!o)return;let r=()=>queueMicrotask(()=>{let d=t.checked;G(e.local,e.bind,e.controlled,d,n),t.checked=!!j(e.local,e.bind,e.controlled),n.redraw()});return o.addEventListener("reset",r),()=>o.removeEventListener("reset",r)}function Fc(e){return e==null?[]:Array.isArray(e)?e:[e]}var Ot=jc;var Vi=Symbol("sinewy-select"),Vc=i`select
...
`,Ko=i((e,t)=>as({...e,"aria-label":e["aria-label"]??e.textValue},i`span`(t),i`span`({"aria-hidden":"true",data:{selectionIndicator:""}},"\u2713"))),st=i(({id:e,multiple:t,value:n,defaultValue:o,bind:r,dir:d,filter:a,formatValue:c,onvaluechange:s,size:l="2",color:p="accent",highContrast:h=!1,data:u,style:g,...m},f,y)=>{let v={size:l,color:p,highContrast:h},x=Object.create(y);return x[ed]=v,os({...m,id:e,style:q(p,g),data:$(u,v)},i({context:x},()=>Ke({id:e,multiple:t,value:n,defaultValue:o,bind:r,dir:d,filter:a,formatValue:c,onvaluechange:s},f)))});st.Control=Lt(rs);st.Pills=Lt(is);st.Input=Lt(ds);st.Content=Lt(Uo);st.Item=Lt(Ko);function Lt(e){return i((t,n,o)=>{let{size:r="2",highContrast:d=!1}=o[ed]||{};return e({...t,data:$(t.data,{size:r,highContrast:d})},n)})}var ae=st;var In=An({name:"CustomSelect",selectOnly:!0}),td=Symbol("sinewy-custom-select-theme"),cs=i`div
  position relative
  width min(100%, 320px)
  color $sinewy-neutral-12
  font-family inherit
...
`,od=i(({defaultChecked:e=!1},[],t)=>{let n=W(!!e,t),o={local:n,defaultChecked:!!e,bind:void 0,controlled:void 0};return({checked:r,defaultChecked:d,bind:a,oncheckedchange:c,onchange:s,dom:l,disabled:p=!1,size:h,color:u,highContrast:g,type:m,role:f,value:y="on",data:v,style:x,...w},[],k)=>{let b=k[nd],S=h??b?.size??"2",I=u??b?.color??"accent",H=g??b?.highContrast??!1,K=String(y),Be=b?void 0:r;o.bind=a,o.controlled=Be,!b&&Y(n,a,k);let oe=b?b.renderValue.includes(K):!!j(n,a,r);return ps({...w,type:"checkbox",name:b?.name??w.name,value:K,checked:oe,disabled:p,style:q(I,x),data:$(v,{size:S,color:I,highContrast:H,state:oe?"checked":"unchecked"}),dom:[te=>hs(o,b,te,k),...rd(l)],onchange:(te,ut,Bn,ht)=>{z(s,te,ut,Bn,ht);let Bt=ut.checked;if(b){let ir=Bt?[...new Set([...b.renderValue,K])]:b.renderValue.filter(Id=>Id!==K);G(b.local,b.bind,b.controlled,ir,b.context),c&&c(Bt,te),b.onvaluechange&&b.onvaluechange(ir,te),b.controlled!==void 0&&gs(b)}else G(n,a,r,Bt,k),c&&c(Bt,te),r!==void 0&&(ut.checked=oe)}})}}),us=i(({defaultValue:e=[]},[],t)=>{let n=Yo(e),o=W(n,t),r={local:o,defaultValue:n,bind:void 0,controlled:void 0,renderValue:n,context:t,element:void 0,onvaluechange:void 0,name:void 0,size:"2",color:"accent",highContrast:!1},d=Object.create(t);return d[nd]=r,({value:a,defaultValue:c,bind:s,onvaluechange:l,name:p,disabled:h=!1,size:u="2",color:g="accent",highContrast:m=!1,dom:f,data:y,style:v,...x},w,k)=>(r.bind=s,r.controlled=a===void 0?void 0:Yo(a),r.context=k,r.onvaluechange=l,r.name=p,r.size=u,r.color=g,r.highContrast=m,Y(o,s,k),r.renderValue=Yo(j(o,s,r.controlled)),i({context:d},()=>Pn({...x,disabled:h,style:q(g,v),data:$(y,{size:u,color:g,highContrast:m}),dom:[b=>fs(r,b),...rd(f)]},w)))});od.Group=us;function hs(e,t,n,o){if(n.defaultChecked=t?t.defaultValue.includes(n.value):e.defaultChecked,t)return;let r=n.form;if(!r)return;let d=()=>queueMicrotask(()=>{let a=n.checked;G(e.local,e.bind,e.controlled,a,o),n.checked=!!j(e.local,e.bind,e.controlled),o.redraw()});return r.addEventListener("reset",d),()=>r.removeEventListener("reset",d)}function fs(e,t){e.element=t;let n=t.form;if(!n)return;let o=()=>queueMicrotask(()=>{let r=[...e.defaultValue];G(e.local,e.bind,e.controlled,r,e.context),e.context.redraw()});return n.addEventListener("reset",o),()=>n.removeEventListener("reset",o)}function gs(e){e.element?.querySelectorAll('input[type="checkbox"]').forEach(t=>{t.checked=e.renderValue.includes(t.value)}),e.context.redraw()}function Yo(e){return e==null?[]:[...new Set([...e].map(String))]}function rd(e){return e==null?[]:Array.isArray(e)?e:[e]}var lt=od;var id=Symbol("sinewy-radio-group"),zn=Symbol("sinewy-radio-names"),ms=i`input
  width 18
  height 18
  display inline-grid
  place-content center
...
`,dd=i(({defaultChecked:e=!1},[],t)=>{let n=W(!!e,t),o={local:n,defaultChecked:!!e,bind:void 0,controlled:void 0};return({checked:r,defaultChecked:d,bind:a,oncheckedchange:c,onchange:s,dom:l,disabled:p=!1,size:h,color:u,highContrast:g,type:m,role:f,value:y="on",data:v,style:x,...w},[],k)=>{let b=k[id],S=h??b?.size??"2",I=u??b?.color??"accent",H=g??b?.highContrast??!1,K=String(y);o.bind=a,o.controlled=b?void 0:r,!b&&Y(n,a,k);let Be=b?b.renderValue===K:!!j(n,a,r);return ms({...w,type:"radio",name:b?.name??w.name,value:K,checked:Be,required:b&&b.required||w.required,disabled:p,style:q(I,x),data:$(v,{size:S,color:I,highContrast:H,state:Be?"checked":"unchecked"}),dom:[oe=>ys(o,b,oe,k),...ad(l)],onchange:(oe,te,ut,Bn)=>{z(s,oe,te,ut,Bn);let ht=te.checked;b&&ht?(G(b.local,b.bind,b.controlled,K,b.context),c&&c(!0,oe),b.onvaluechange&&b.onvaluechange(K,oe),b.controlled!==void 0&&ws(b)):b||(G(n,a,r,ht,k),c&&c(ht,oe),r!==void 0&&(te.checked=Be))}})}}),bs=i(({name:e,defaultValue:t},[],n)=>{let o=e||xs(n),r=_o(t),d=W(r,n),a={local:d,defaultValue:r,bind:void 0,controlled:void 0,renderValue:r,context:n,element:void 0,onvaluechange:void 0,name:o,required:!1,size:"2",color:"accent",highContrast:!1},c=Object.create(n);return c[id]=a,({value:s,defaultValue:l,bind:p,onvaluechange:h,name:u=o,required:g=!1,disabled:m=!1,size:f="2",color:y="accent",highContrast:v=!1,dom:x,data:w,style:k,...b},S,I)=>(a.bind=p,a.controlled=_o(s),a.context=I,a.onvaluechange=h,a.name=u,a.required=g,a.size=f,a.color=y,a.highContrast=v,Y(d,p,I),a.renderValue=_o(j(d,p,a.controlled)),i({context:c},()=>Pn({...b,disabled:m,style:q(y,k),data:$(w,{size:f,color:y,highContrast:v}),dom:[H=>vs(a,H),...ad(x)]},S)))});dd.Group=bs;function ys(e,t,n,o){if(n.defaultChecked=t?t.defaultValue===n.value:e.defaultChecked,t)return;let r=n.form;if(!r)return;let d=()=>queueMicrotask(()=>{let a=n.checked;G(e.local,e.bind,e.controlled,a,o),n.checked=!!j(e.local,e.bind,e.controlled),o.redraw()});return r.addEventListener("reset",d),()=>r.removeEventListener("reset",d)}function vs(e,t){e.element=t;let n=t.form;if(!n)return;let o=()=>queueMicrotask(()=>{G(e.local,e.bind,e.controlled,e.defaultValue,e.context),e.context.redraw()});return n.addEventListener("reset",o),()=>n.removeEventListener("reset",o)}function ws(e){e.element?.querySelectorAll('input[type="radio"]').forEach(t=>{t.checked=t.value===e.renderValue}),e.context.redraw()}function xs(e){let t=e;for(;t&&!Object.prototype.hasOwnProperty.call(t,zn);)t=Object.getPrototypeOf(t);return t||=e,t[zn]=(t[zn]||0)+1,"sinewy-radio-"+t[zn]}function _o(e){return e==null?void 0:String(e)}function ad(e){return e==null?[]:Array.isArray(e)?e:[e]}var pt=dd;var cd=Symbol("sinewy-theme"),ks=R.Content`
